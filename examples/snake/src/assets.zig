...
// TODO: move
pub const Size = struct { width: u32, hight: u32 };
pub const Position = struct { x: i32, y: i32 };
pub const Region = struct { position: Position, size: Size };

// TODO: move
pub const Sprite = struct { image_data: []u8, image_size: Size, sprite_region: Region };

pub fn createSprite(image_data: []u8, image_size: Size, sprite_position: Position, sprite_size: Size) Sprite {
...
pub const BACKGROUND: Sprite = createSprite(IMG_BACKGROUND, square(384), xy(0, 0), square(384));
